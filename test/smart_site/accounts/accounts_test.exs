defmodule SmartSite.AccountsTest do
  use SmartSite.DataCase
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "some email", last_name: "some last_name", name: "some name", password: "some password", username: "some username"}
